...
describe('logic', () => {
    ...
    afterEach(async ()=>  await logic.logOut())
    ...
    !false && describe('users', () => {
        describe('register User', () => {
            ...
            it('should succed on correct data', async () => {
                const res = await logic.register(name, surname, email, password, birthday, gender, phone)
            ...
            it('should fail on already exist user', async () => {
                ...
                try {
                    await logic.register(_name, _surname, email, _password, _birthday, _gender, _phone)
            ...
            it('should fail on undefined name', () => {
                expect(() => { logic.register(undefined, surname, email, password, birthday, gender, phone) }).to.throw(TypeError, 'undefined is not a string')
            })

            it('should fail on undefined surname', () => {
                expect(() => { logic.register(name, undefined, email, password, birthday, gender, phone) }).to.throw(TypeError, 'undefined is not a string')
            })
            it('should fail on undefined email', () => {
                expect(() => { logic.register(name, surname, undefined, password, birthday, gender, phone) }).to.throw(TypeError, 'undefined is not a string')
            })
            it('should fail on undefined password', () => {
                expect(() => { logic.register(name, surname, email, undefined, birthday, gender, phone) }).to.throw(TypeError, 'undefined is not a string')
            })
            it('should fail on undefined birthday', () => {
                expect(() => { logic.register(name, surname, email, password, undefined, gender, phone) }).to.throw(TypeError, 'undefined is not a string')
            })
            it('should succed on undefined gender', async () => {

                const res = await logic.register(name, surname, email, password, birthday, undefined, phone)
            ...
            it('should succed on undefined gender', async () => {
                ...
                const res = await logic.register(name, surname, email, password, birthday, gender, undefined)
            ...
            it('should succed on null gender', async () => {
                const res = await logic.register(name, surname, email, password, birthday, null, phone)
            ...
            it('should succed on null phone', async () => {
                const res = await logic.register(name, surname, email, password, birthday, gender, null)
            ...
            it('should fail on empty name', () => {
                expect(() => { logic.register('', surname, email, password, birthday, gender, phone) }).to.throw(Error, `name is empty or blank`)
            })

            it('should fail on empty surname', () => {
                expect(() => { logic.register(name, '', email, password, birthday, gender, phone) }).to.throw(Error, `surname is empty or blank`)
            })
            it('should fail on empty email', () => {
                expect(() => { logic.register(name, surname, '', password, birthday, gender, phone) }).to.throw(Error, `email is empty or blank`)
            })
            it('should fail on empty password', () => {
                expect(() => { logic.register(name, surname, email, '', birthday, gender, phone) }).to.throw(Error, `password is empty or blank`)
            })
            it('should fail on empty birthday', () => {
                expect(() => { logic.register(name, surname, email, password, '', gender, phone) }).to.throw(Error, `birthday is empty or blank`)
            })
            ...
            it('should fail on non-string name(object)', () => {
                expect(() => { logic.register({ name }, surname, email, password, birthday, gender, phone) }).to.throw(TypeError, '[object Object] is not a string')
            })
            ...
            it('should fail on non-string name(boolean)', () => {
                expect(() => { logic.register(true, surname, email, password, birthday, gender, phone) }).to.throw(TypeError, 'true is not a string')
            })

            it('should fail on non-string surname(boolean)', () => {
                expect(() => { logic.register(name, true, email, password, birthday, gender, phone) }).to.throw(TypeError, 'true is not a string')
            })
            it('should fail on non-string email(boolean)', () => {
                expect(() => { logic.register(name, surname, true, password, birthday, gender, phone) }).to.throw(TypeError, 'true is not a string')
            })
            it('should fail on non-string password(boolean)', () => {
                expect(() => { logic.register(name, surname, email, true, birthday, gender, phone) }).to.throw(TypeError, 'true is not a string')
            })
            it('should fail on non-string birthday(boolean)', () => {
                expect(() => { logic.register(name, surname, email, password, true, gender, phone) }).to.throw(TypeError, 'true is not a string')
            })

            it('should fail on non-string gender(boolean)', () => {
                expect(() => { logic.register(name, surname, email, password, birthday, true, phone) }).to.throw(TypeError, 'true is not a string')
            })
            it('should fail on non-string phone(boolean)', () => {
                expect(() => { logic.register(name, surname, email, password, birthday, gender, true) }).to.throw(TypeError, 'true is not a string')
            })
            ...
            it('should fail on non-string name(array)', () => {
                expect(() => { logic.register([], surname, email, password, birthday, gender, phone) }).to.throw(TypeError, ' is not a string')
            })

            it('should fail on non-string surname(array)', () => {
                expect(() => { logic.register(name, [], email, password, birthday, gender, phone) }).to.throw(TypeError, ' is not a string')
            })
            it('should fail on non-string email(array)', () => {
                expect(() => { logic.register(name, surname, [], password, birthday, gender, phone) }).to.throw(TypeError, ' is not a string')
            })
            it('should fail on non-string password(array)', () => {
                expect(() => { logic.register(name, surname, email, [], birthday, gender, phone) }).to.throw(TypeError, ' is not a string')
            })
            it('should fail on non-string birthday(array)', () => {
                expect(() => { logic.register(name, surname, email, password, [], gender, phone) }).to.throw(TypeError, ' is not a string')
            })

            it('should fail on non-string gender(array)', () => {
                expect(() => { logic.register(name, surname, email, password, birthday, [], phone) }).to.throw(TypeError, ' is not a string')
            })
            it('should fail on non-string phone(array)', () => {
                expect(() => { logic.register(name, surname, email, password, birthday, gender, []) }).to.throw(TypeError, ' is not a string')
            })
            ...
            it('should fail on non-string name(number)', () => {
                ...
                expect(() => { logic.register(number, surname, email, password, birthday, gender, phone) }).to.throw(TypeError, `${number} is not a string`)
            })

            it('should fail on non-string surname(number)', () => {
                let number = Math.random()

                expect(() => { logic.register(name, number, email, password, birthday, gender, phone) }).to.throw(TypeError, `${number} is not a string`)
            })
            it('should fail on non-string email(number)', () => {
                let number = Math.random()

                expect(() => { logic.register(name, surname, number, password, birthday, gender, phone) }).to.throw(TypeError, `${number} is not a string`)
            })
            it('should fail on non-string password(number)', () => {
                let number = Math.random()

                expect(() => { logic.register(name, surname, email, number, birthday, gender, phone) }).to.throw(TypeError, `${number} is not a string`)
            })
            it('should fail on non-string birthday(number)', () => {
                let number = Math.random()

                expect(() => { logic.register(name, surname, email, password, number, gender, phone) }).to.throw(TypeError, `${number} is not a string`)
            })

            it('should fail on non-string gender(number)', () => {
                let number = Math.random()

                expect(() => { logic.register(name, surname, email, password, birthday, number, phone) }).to.throw(TypeError, `${number} is not a string`)
            })
            it('should fail on non-string phone(number)', () => {
                let number = Math.random()

                expect(() => { logic.register(name, surname, email, password, birthday, gender, number) }).to.throw(TypeError, `${number} is not a string`)
            })
        })
        ...
        describe('log In', () => {
            ...
            it('should succed on correct data', async () => {
                ...
                const res= await logic.logIn(email, password)
            ...
            it('should fail on non existing user', async () => {
                ...
                try {
                    const id = await logic.logIn(email, password)
                    expect(true).to.be.false
                } catch (error) {
                    expect(error).to.be.instanceof(Error)
            ...
            it('should fail on incorrect password ', async () => {
                ...
                try {
                    const id = await logic.logIn(email, wrongPassword)
                    expect(true).to.be.false
                } catch (error) {
                    expect(error).to.be.instanceof(Error)
            ...
            it('should fail on undefined password', () => {
                expect(() => { logic.logIn(user.email, undefined) }).to.throw(TypeError, 'undefined is not a string')
            })

            it('should fail on empty email', () => {
                expect(() => { logic.logIn('', user.password) }).to.throw(Error, `email is empty or blank`)
            })

            it('should fail on empty password', () => {
                expect(() => { logic.logIn(user.email, '') }).to.throw(Error, `password is empty or blank`)
            })
            ...
            it('should fail on non-string email(object)', () => {
                expect(() => { logic.logIn({}, user.password) }).to.throw(TypeError, '[object Object] is not a string')
            })

            it('should fail on non-string password(object)', () => {
                expect(() => { logic.logIn(user.email, {}) }).to.throw(TypeError, '[object Object] is not a string')
            })

            it('should fail on non-string email(boolean)', () => {
                expect(() => { logic.logIn(false, user.password) }).to.throw(TypeError, 'false is not a string')
            })
            it('should fail on non-string password(boolean)', () => {
                expect(() => { logic.logIn(user.email, false) }).to.throw(TypeError, 'false is not a string')
            })

            it('should fail on non-string email(array)', () => {
                expect(() => { logic.logIn([], user.password) }).to.throw(TypeError, ' is not a string')
            })
            it('should fail on non-string password(array)', () => {
                expect(() => { logic.logIn(user.email, []) }).to.throw(TypeError, ' is not a string')
            })

            it('should fail on non-string email(number)', () => {
                const email = Math.random()

                expect(() => logic.logIn(email, user.password)).to.throw(TypeError, `${email} is not a string`)
            })

            it('should fail on non-string password(number)', () => {
                const password = Math.random()

                expect(() => logic.logIn(user.email, password)).to.throw(TypeError, `${password} is not a string`)
            })
        })
        ...
        describe('retrieve User', () => {
            ...
            beforeEach(async () => {
                ...
                await logic.logIn(user.email, password)
            })
            ...
            it('should fail on non existing user', async () => {
                ...
                try {
                    const __user = await logic.retrieveUser()
        ...
        false && describe('add profile pictures ', () => {
            ...
            it('should succed on correct data', async () => {
                ...
                const picture = await logic.uploadProfilePicture(image)
...
debugger
            ...
            it('it should succedd on correct data', async () => {
                const res = await logic.uploadFavourites(place.id)
            ...
            it('should fail on non existing place', async () => {
                ...
                try {
                    const res = await logic.uploadFavourites(id)
            ...
            it('should fail on empty place id', async () => {
                expect(() => logic.uploadFavourites(user.id, '')).to.throw(Error, `placeId is empty or blank`)
            })
        ...
        describe('list favourites', () => {
            ...
            it('should fail on empty id', async () => {
                expect(() => logic.listFavourites('')).to.throw(Error, `userId is empty or blank`)
            })
        ...
        describe('add CheckIns', () => {
            ...
            it('should fail on empty user id', async () => {
                expect(() => logic.uploadCheckIns('', place.id)).to.throw(Error, `userId is empty or blank`)
            })

            it('should fail on empty place id', async () => {
                expect(() => logic.uploadCheckIns(user.id, '')).to.throw(Error, `placeId is empty or blank`)
            })
        ...
        describe('list CheckIns', () => {
            ...
            it('should fail on empty id', async () => {
                expect(() => logic.listCheckIns('')).to.throw(Error, `userId is empty or blank`)
            })
    ...
    false && describe('places', () => {
        ...
        describe('add place', () => {
            ...
            it('should fail on empty name', () => {
                expect(() => logic.addPlace('', latitude, longitude, address, userId, breakfast, lunch, dinner, coffee, nightLife, thingsToDo)).to.throw(Error, `name is empty or blank`)
            })

            it('should fail on empty address', () => {
                expect(() => logic.addPlace(placeName, latitude, longitude, '', userId, breakfast, lunch, dinner, coffee, nightLife, thingsToDo)).to.throw(Error, `address is empty or blank`)
            })
            it('should fail on empty userId', () => {
                expect(() => logic.addPlace(placeName, latitude, longitude, address, '', breakfast, lunch, dinner, coffee, nightLife, thingsToDo)).to.throw(Error, `userId is empty or blank`)
            })
        ...
        describe('retrieve place by Id', () => {
            ...
            it('should fail on empty user id', async () => {
                expect(() => logic.retrievePlaceById('', place.id)).to.throw(Error, `userId is empty or blank`)
            })

            it('should fail on empty place id', async () => {
                expect(() => logic.retrievePlaceById(user.id, '')).to.throw(Error, `placeId is empty or blank`)
            })
        ...
        describe('update scoring', () => {
            ...
            it('should fail on empty user id', async () => {
                expect(() => logic.updateScoring('', place.id, newScore)).to.throw(Error, `userId is empty or blank`)
            })

            it('should fail on empty place id', async () => {
                expect(() => logic.updateScoring(user.id, '', newScore)).to.throw(Error, `placeId is empty or blank`)
            })
    ...
    false && describe('pictures', () => {
        ...
        describe('add place pictures ', () => {
            ...
            it('should fail on empty user id', async () => {
                expect(() => logic.addPlacePicture('', place.id, file)).to.throw(Error, `userId is empty or blank`)
            })

            it('should fail on empty place id', async () => {
                expect(() => logic.addPlacePicture(user.id, '', file)).to.throw(Error, `placeId is empty or blank`)
            })
        ...
        describe('list place pictures', () => {
            ...
            it('should fail on empty place id', async () => {
                expect(() => logic.listPlacePictures('')).to.throw(Error, `placeId is empty or blank`)
            })
        ...
        describe('list user pictures', () => {
            ...
            it('should fail on empty user id', async () => {
                expect(() => logic.listUserPictures('')).to.throw(Error, `userId is empty or blank`)
            })
    ...
    false && describe('tips', () => {
        ...
        describe('add tips', () => {
            ...
            it('should fail on empty user id', async () => {
                expect(() => logic.addTip('', place.id, text)).to.throw(Error, `userId is empty or blank`)
            })

            it('should fail on empty place id', async () => {
                expect(() => logic.addTip(user.id, '', text)).to.throw(Error, `placeId is empty or blank`)
            })

            it('should fail on empty text', async () => {
                expect(() => logic.addTip(user.id, place.id, '')).to.throw(Error, `text is empty or blank`)
            })
        ...
        describe('list tips by place Id', () => {
            ...
            it('should fail on empty place id', async () => {
                expect(() => logic.listPlaceTips('')).to.throw(Error, `placeId is empty or blank`)
            })
        ...
        describe('list tips by user Id', () => {
            ...
            it('should succced on correct data', async () => {
                ...
                expect(_tip.scoring).to.equal(place.scoring)
                expect(_tip.time).to.equal(tip.time)
            })
            ...
            it('should fail on empty id', async () => {
                expect(() => logic.listUserTips('')).to.throw(Error, `userId is empty or blank`)
            })
